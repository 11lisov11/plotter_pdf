...
from scripts import prepare_mahoviki_dxf2gcode as base
...
class GostOutlineRenderer:
    ...
    def render_stamp_completion_source_mm(self) -> list[Polyline]:
        ...
        labels = [
            ("Изм.", 21.20, 57.10, 2.25),
            ("Лист", 30.60, 57.10, 2.25),
            ("Разраб.", 21.30, 52.20, 2.25),
            ("Пров.", 21.30, 47.20, 2.25),
            ("Т.контр.", 21.30, 42.20, 2.25),
            ("Н.контр.", 21.30, 37.20, 2.25),
            ("Утв.", 21.30, 32.20, 2.25),
            ("Лит.", 157.00, 42.20, 2.25),
            ("Масса", 173.20, 42.20, 2.25),
            ("Масштаб", 190.00, 42.20, 2.25),
            ("Лист", 157.00, 21.85, 2.25),
            ("Листов", 175.80, 21.85, 2.25),
        ]
