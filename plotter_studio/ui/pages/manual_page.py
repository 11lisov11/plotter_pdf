...
from PySide6.QtWidgets import QDoubleSpinBox, QFrame, QGridLayout, QLabel, QPushButton, QVBoxLayout, QWidget
...
class ManualPage(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        title = QLabel("Ручное управление и сервис", card)
        title.setObjectName("SectionTitle")
        layout.addWidget(title)

        hint = QLabel("Точное управление Z-осью и сервисные команды.", card)
    ...
    def set_connected_enabled(self, enabled: bool) -> None:
        ...
        # Отпуск моторов должен быть доступен всегда (по выбранному COM).
    ...
    def set_pencil_banner(self, text: str, alert: bool) -> None:
        ...
        self.sharpen_banner.setStyleSheet(f"color: {color}; font-weight: 600;")
