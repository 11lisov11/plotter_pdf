...
def _write_ready_a3_variant(root: Path) -> Path:
    ...
    (package / "pass_02.nc").write_text("G0 X2 Y2\n", encoding="utf-8")
    (package / "summary.csv").write_text(
        "ok,item,nc,draw_length_m,bounds,preview_pdf,preview_svg,gcode\n"
        "True,pass_01,pass_01.nc,6.7,\"x(0,1) y(-1,0)\",pass_01.pdf,pass_01.svg,pass_01.gcode\n"
        "True,pass_02,pass_02.nc,6.9,\"x(0,1) y(-1,0)\",pass_02.pdf,pass_02.svg,pass_02.gcode\n",
        encoding="utf-8",
    )
    (variant / "_audit.json").write_text(
        json.dumps(
