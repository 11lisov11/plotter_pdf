...
# 390 x 580 mm, leaving 15 mm at left/right and 7 mm at top/bottom.
...
A2_ZONE_LAYOUTS: dict[str, dict[str, tuple[float, float, float, float]]] = {
    "a2_single": {"A2": (15.0, 7.0, 405.0, 587.0)},
    "a3_pair": {
        "1": (15.0, 297.0, 405.0, 587.0),
        "2": (15.0, 7.0, 405.0, 297.0),
    },
    "a4_quad": {
        "11": (15.0, 297.0, 210.0, 587.0),
        "12": (210.0, 297.0, 405.0, 587.0),
        "21": (15.0, 7.0, 210.0, 297.0),
        "22": (210.0, 7.0, 405.0, 297.0),
    },
    "mixed_a3_near": {
        "1": (15.0, 297.0, 405.0, 587.0),
        "21": (15.0, 7.0, 210.0, 297.0),
