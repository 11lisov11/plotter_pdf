...
out=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_layered_cap_compare')
out.mkdir(parents=True,exist_ok=True)
items=[
 ('source',Path(r'C:\Users\USER\Downloads\f3370dc25e274d3fa82ef06fc8258ba5_gemini-3.1-flash-image-preview.jpg')),
 ('tilebundles clean',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_pencil_density_tilebundles_a4_pack\gemini_pencil_density_tilebundles_a4_preview_black_actual.png')),
 ('layered cap',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_layered_cap_a4_pack\gemini_layered_cap_a4_preview_black_actual.png')),
 ('overdense rejected',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_layered_tonebundles_a4_pack\gemini_layered_tonebundles_a4_preview_black_actual.png')),
]
...
png=out/'layered_cap_compare.png'; pdf=out/'layered_cap_compare.pdf'; img.save(png)
