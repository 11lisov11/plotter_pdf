...
out=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_subject_focus_v3_compare')
out.mkdir(parents=True,exist_ok=True)
items=[
 ('source',Path(r'C:\Users\USER\Downloads\f3370dc25e274d3fa82ef06fc8258ba5_gemini-3.1-flash-image-preview.jpg')),
 ('subject_focus',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_hybrid_subject_focus_a4_pack\gemini_hybrid_subject_focus_a4_preview_black_actual.png')),
 ('subject_focus_v2',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_hybrid_subject_focus_v2_a4_pack\gemini_hybrid_subject_focus_v2_a4_preview_black_actual.png')),
 ('subject_focus_v3',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_hybrid_subject_focus_v3_a4_pack\gemini_hybrid_subject_focus_v3_a4_preview_black_actual.png')),
]
...
png=out/'subject_focus_v3_compare.png'; pdf=out/'subject_focus_v3_compare.pdf'; img.save(png)
