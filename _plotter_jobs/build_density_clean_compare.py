...
out=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_density_clean_compare')
out.mkdir(parents=True,exist_ok=True)
items=[
 ('source',Path(r'C:\Users\USER\Downloads\f3370dc25e274d3fa82ef06fc8258ba5_gemini-3.1-flash-image-preview.jpg')),
 ('aggressive density gray',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_density_guided_hatch_a4_pack\gemini_density_guided_hatch_preview_pressure_gray.png')),
 ...
 ('clean black actual',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_density_guided_clean_a4_pack\gemini_density_guided_clean_preview_black_actual.png')),
]
...
png=out/'density_clean_compare.png'; pdf=out/'density_clean_compare.pdf'; img.save(png)
