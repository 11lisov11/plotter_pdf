...
out=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_threshold_layers_compare')
out.mkdir(parents=True,exist_ok=True)
items=[
 ('source',Path(r'C:\Users\USER\Downloads\f3370dc25e274d3fa82ef06fc8258ba5_gemini-3.1-flash-image-preview.jpg')),
 ('layered_cap current best',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_layered_cap_a4_pack\gemini_layered_cap_a4_preview_black_actual.png')),
 ('threshold_plus cleaner but weak',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_tonal_threshold_layers_plus_a4_pack\gemini_tonal_threshold_layers_plus_a4_preview_black_actual.png')),
]
...
png=out/'threshold_layers_compare.png'; pdf=out/'threshold_layers_compare.pdf'; img.save(png)
