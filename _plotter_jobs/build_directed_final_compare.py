...
out=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_directed_final_compare')
out.mkdir(parents=True,exist_ok=True)
items=[
 ('source',Path(r'C:\Users\USER\Downloads\f3370dc25e274d3fa82ef06fc8258ba5_gemini-3.1-flash-image-preview.jpg')),
 ('layered_cap best density',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_layered_cap_a4_pack\gemini_layered_cap_a4_preview_black_actual.png')),
 ('directed_noicons cleaner',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_directed_density_noicons_a4_pack\gemini_directed_density_noicons_a4_preview_black_actual.png')),
 ('organic_v2 light field',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_organic_density_v2_a4_pack\gemini_organic_density_v2_a4_preview_black_actual.png')),
]
...
png=out/'directed_final_compare.png'; pdf=out/'directed_final_compare.pdf'; img.save(png)
