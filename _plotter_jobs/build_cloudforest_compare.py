...
out=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_cloudforest_compare')
out.mkdir(parents=True,exist_ok=True)
items=[
 ('source',Path(r'C:\Users\USER\Downloads\f3370dc25e274d3fa82ef06fc8258ba5_gemini-3.1-flash-image-preview.jpg')),
 ('figurefolds black',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_density_plus_figurefolds_a4_pack\gemini_density_plus_figurefolds_preview_black_actual.png')),
...
png=out/'cloudforest_compare.png'; pdf=out/'cloudforest_compare.pdf'; img.save(png)
