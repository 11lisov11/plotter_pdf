...
out=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_figurefolds_compare')
...
items=[
 ...
 ('plus figurefolds black',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_density_plus_figurefolds_a4_pack\gemini_density_plus_figurefolds_preview_black_actual.png')),
]
...
png=out/'figurefolds_compare.png'; pdf=out/'figurefolds_compare.pdf'; img.save(png)
