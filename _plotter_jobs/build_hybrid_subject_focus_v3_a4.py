...
OUT=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_hybrid_subject_focus_v3_a4_pack'); OUT.mkdir(parents=True,exist_ok=True)
...
name='gemini_hybrid_subject_focus_v3_a4'; nc=OUT/f'{name}.nc'; gcode=OUT/f'{name}.gcode'
lines=['; hybrid subject focus v3 A4','G21','G90',f'G0 Z{UP:.3f}',f'F{TF}']; draw=travel=0; last=(0,0)
...
print('HYBRID SUBJECT FOCUS V3 A4 package'); print('paths_total:',len(ordered)); print('kind_counts:',dict(counts)); print('draw_length_m:',round(draw/1000,2)); print('travel_length_m:',round(travel/1000,2)); print('estimated_time_min_ideal:',round((draw/(DF/60)+travel/(TF/60))/60,1)); print('preview:',black); print('pdf:',blackpdf); print('nc:',nc)
