...
out=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_hatch_density_compare')
...
items=[
 ...
 ('hatch_density controlled',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_hatch_density_controlled_a4_pack\gemini_hatch_density_controlled_a4_preview_black_actual.png')),
]
...
png=out/'hatch_density_compare.png'; pdf=out/'hatch_density_compare.pdf'; img.save(png)
