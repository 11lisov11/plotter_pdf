...
out=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_cloudshadows_compare')
...
items=[
 ...
 ('cloudshadows black',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_density_plus_cloudshadows_a4_pack\gemini_density_plus_cloudshadows_preview_black_actual.png')),
]
...
png=out/'cloudshadows_compare.png'; pdf=out/'cloudshadows_compare.pdf'; img.save(png)
