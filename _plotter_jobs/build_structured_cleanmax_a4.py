...
OUT = Path(r"C:\plotter_pdf\_plotter_jobs\gemini_structured_cleanmax_a4_pack")
...
# Save G-code / NC.
name = "gemini_structured_cleanmax_a4"
nc_path = OUT / f"{name}.nc"
gcode_path = OUT / f"{name}.gcode"
lines = [
    "; structured cleanmax A4 - coherent density hatching",
    "G21",
    "G90",
    f"G0 Z{PEN_UP_Z:.3f}",
    f"F{TRAVEL_F}",
...
readme.write_text(
    "STRUCTURED CLEANMAX A4 package\n"
    f"source: {SRC}\n"
    f"nc: {nc_path}\n"
    f"gcode: {gcode_path}\n"
...
print("STRUCTURED CLEANMAX A4 package")
