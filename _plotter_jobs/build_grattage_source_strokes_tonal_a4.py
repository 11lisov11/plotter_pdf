...
OUT_DIR = Path(r'C:\plotter_pdf\_plotter_jobs\gemini_grattage_source_strokes_tonal_a4_pack')
NAME = 'gemini_grattage_source_strokes_tonal_a4'
PAGE_W_MM = 180.0
PAGE_H_MM = 280.0
MARGIN_MM = 4.0
DRAW_FEED = 1400.0
...
def write_gcode(path: Path):
    draw = 0.0
    travel = 0.0
    lines = ['; grattage/source-stroke tonal A4', 'G21', 'G90', 'G0 Z3.500']
    cur = (0.0, 0.0)
    for p in ordered:
        sx, sy = p[0]
...
readme.write_text(
    f'GRATTAGE SOURCE STROKES + TONAL HATCH A4\n'
    f'source: {SRC}\n'
...
print('GRATTAGE SOURCE STROKES + TONAL HATCH A4 package')
