...
out=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_flowfield_compare')
...
items=[
 ...
 ('flowfield smoother but weaker',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_flowfield_density_a4_pack\gemini_flowfield_density_a4_preview_black_actual.png')),
]
...
png=out/'flowfield_compare.png'; pdf=out/'flowfield_compare.pdf'; img.save(png)
