...
out=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_hybrid_best_compare')
out.mkdir(parents=True,exist_ok=True)
items=[
 ('source',Path(r'C:\Users\USER\Downloads\f3370dc25e274d3fa82ef06fc8258ba5_gemini-3.1-flash-image-preview.jpg')),
 ('layered_cap previous best',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_layered_cap_a4_pack\gemini_layered_cap_a4_preview_black_actual.png')),
 ('hybrid_best_density',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_hybrid_best_density_a4_pack\gemini_hybrid_best_density_a4_preview_black_actual.png')),
]
...
png=out/'hybrid_best_compare.png'; pdf=out/'hybrid_best_compare.pdf'; img.save(png)
