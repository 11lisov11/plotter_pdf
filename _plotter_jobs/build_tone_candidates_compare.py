...
out=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_tone_candidates_compare')
out.mkdir(parents=True,exist_ok=True)
items=[
 ('source',Path(r'C:\Users\USER\Downloads\f3370dc25e274d3fa82ef06fc8258ba5_gemini-3.1-flash-image-preview.jpg')),
 ('longdetail black',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_density_pure_flow_longdetail_a4_pack\gemini_density_pure_flow_longdetail_preview_black_actual.png')),
 ('tone levels black',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_density_tone_levels_a4_pack\gemini_density_tone_levels_preview_black_actual.png')),
...
thumb_w=520; pad=18; label_h=34; font=ImageFont.load_default(); thumbs=[]
...
png=out/'tone_candidates_compare.png'; pdf=out/'tone_candidates_compare.pdf'; img.save(png)
