...
OUT=Path(r"C:\plotter_pdf\_plotter_jobs\gemini_multilevel_true_strokes_a4_pack")
...
def add_scan(name, angle, spacing, threshold, y0f,y1f,x0f,x1f,min_len,bias,keep):
    ...
    return made
extra_counts={}
extra_counts['jacket_soft_cross']=add_scan('jacket_soft_cross',54,10,.45,.62,.99,.27,.62,9,.10,.55)
extra_counts['jacket_deep_cross']=add_scan('jacket_deep_cross',-48,12,.58,.62,.99,.27,.62,8,.18,.45)
...
render(OUT/'gemini_multilevel_true_strokes_preview_pressure_gray.png',True)
render(OUT/'gemini_multilevel_true_strokes_preview_black_actual.png',False,True)
render(OUT/'gemini_multilevel_true_strokes_preview_dark_pressure.png',True,False,True)
SAFE=13.0; lines=['; gemini_multilevel_true_strokes_a4','; multi-threshold true source strokes + minimal dark hatching','G21','G90',f'G0 Z{SAFE:.2f}','G0 X0.000 Y0.000']
...
(OUT/'gemini_multilevel_true_strokes_a4.nc').write_text('\n'.join(lines)+'\n',encoding='utf-8')
(OUT/'gemini_multilevel_true_strokes_a4.gcode').write_text('\n'.join(lines)+'\n',encoding='utf-8')
readme=f"""MULTILEVEL TRUE STROKES A4 package
source: {SRC}
output_dir: {OUT}
...
files:
- gemini_multilevel_true_strokes_preview_pressure_gray.png/pdf
- gemini_multilevel_true_strokes_preview_black_actual.png/pdf
- gemini_multilevel_true_strokes_preview_dark_pressure.png/pdf
- gemini_multilevel_true_strokes_a4.nc
- gemini_multilevel_true_strokes_a4.gcode
"""
