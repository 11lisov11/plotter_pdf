...
out=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_cleanmax_sky_compare')
out.mkdir(parents=True, exist_ok=True)
items=[
 ('source', Path(r'C:\Users\USER\Downloads\f3370dc25e274d3fa82ef06fc8258ba5_gemini-3.1-flash-image-preview.jpg')),
 ('old cloudforest', Path(r'C:\plotter_pdf\_plotter_jobs\gemini_density_plus_cloudforest_a4_pack\gemini_density_plus_cloudforest_preview_black_actual.png')),
 ('new cleanmax sky', Path(r'C:\plotter_pdf\_plotter_jobs\gemini_structured_cleanmax_sky_a4_pack\gemini_structured_cleanmax_sky_a4_preview_black_actual.png')),
]
...
png=out/'cleanmax_sky_compare.png'; pdf=out/'cleanmax_sky_compare.pdf'; img.save(png)
