...
out=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_grassdetail_compare')
...
items=[
 ...
 ('grassdetail black',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_density_plus_grassdetail_a4_pack\gemini_density_plus_grassdetail_preview_black_actual.png')),
]
...
png=out/'grassdetail_compare.png'; pdf=out/'grassdetail_compare.pdf'; img.save(png)
