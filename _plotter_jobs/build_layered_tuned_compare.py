...
out=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_layered_tuned_compare')
out.mkdir(parents=True,exist_ok=True)
items=[
 ('source',Path(r'C:\Users\USER\Downloads\f3370dc25e274d3fa82ef06fc8258ba5_gemini-3.1-flash-image-preview.jpg')),
 ('layered_cap denser',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_layered_cap_a4_pack\gemini_layered_cap_a4_preview_black_actual.png')),
 ('layered_cap_tuned cleaner',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_layered_cap_tuned_a4_pack\gemini_layered_cap_tuned_a4_preview_black_actual.png')),
]
...
png=out/'layered_tuned_compare.png'; pdf=out/'layered_tuned_compare.pdf'; img.save(png)
