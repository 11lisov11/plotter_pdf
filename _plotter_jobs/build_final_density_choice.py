...
out=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_final_density_choice')
out.mkdir(parents=True,exist_ok=True)
items=[
 ('source',Path(r'C:\Users\USER\Downloads\f3370dc25e274d3fa82ef06fc8258ba5_gemini-3.1-flash-image-preview.jpg')),
 ('chosen fullfield black',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_density_tone_levels_fullfield_a4_pack\gemini_density_tone_levels_fullfield_preview_black_actual.png')),
 ('too dark bundled black',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_density_fullfield_bundled_a4_pack\gemini_density_fullfield_bundled_preview_black_actual.png')),
]
...
png=out/'final_density_choice.png'; pdf=out/'final_density_choice.pdf'; img.save(png)
