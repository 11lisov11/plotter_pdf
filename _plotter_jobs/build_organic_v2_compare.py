...
out=Path(r'C:\plotter_pdf\_plotter_jobs\gemini_organic_v2_compare')
out.mkdir(parents=True,exist_ok=True)
items=[
 ('source',Path(r'C:\Users\USER\Downloads\f3370dc25e274d3fa82ef06fc8258ba5_gemini-3.1-flash-image-preview.jpg')),
 ('tilebundles',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_pencil_density_tilebundles_a4_pack\gemini_pencil_density_tilebundles_a4_preview_black_actual.png')),
 ('layered_cap',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_layered_cap_a4_pack\gemini_layered_cap_a4_preview_black_actual.png')),
 ('organic_v2',Path(r'C:\plotter_pdf\_plotter_jobs\gemini_organic_density_v2_a4_pack\gemini_organic_density_v2_a4_preview_black_actual.png')),
]
...
png=out/'organic_v2_compare.png'; pdf=out/'organic_v2_compare.pdf'; img.save(png)
