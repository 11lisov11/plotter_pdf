...
- After that rotation, `pass_02` geometry must be translated by `Y +3.0 mm` relative to machine home.
...
- Canonical rule for agents/scripts/programs:
  ...
  - then apply `translate (0, +3.0 mm)` to the already rotated geometry.
